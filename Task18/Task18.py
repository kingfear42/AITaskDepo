...
net = cv2.dnn.readNetFromDarknet("Task18/yolov4.cfg", "Task18/yolov4.weights")
...
cap = cv2.VideoCapture("Task18/Germany - Argentina World Cup 2014 final _ Highlights _ 4K UHD 60 fps - YouTube - Opera 2026-07-03 01-43-00.mp4")
